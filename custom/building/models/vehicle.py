...
class maintenance_request_resource_material_line(models.Model):
    ...
    def action_open_user_maintenance_request_resource_material_line(self, group):
        ...
        return {
            ...
            'view_mode': 'list',
            'views': [
                (self.env.ref('building.maintenance_request_resource_material_line_tree_view').id, 'list'),
            ],
            'domain': domain,
            'context': context,
    ...
    def action_open_user_maintenance_request_resource_small_material_line(self, group):
        ...
        return {
            ...
            'view_mode': 'list',
            'views': [
                (self.env.ref('building.maintenance_request_resource_small_material_line_tree_view').id, 'list'),
            ],
            'domain': domain,
            'context': context,
